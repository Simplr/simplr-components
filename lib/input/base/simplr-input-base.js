...
export default class SimplrInputBase extends LitElement {
  static get properties() {
    return {
      ...
      /**
       * The matching pattern for the input component
       * @prop
       * @type string
       * */
      pattern: { type: String },
  ...
  firstUpdated() {
    let elem = this.shadowRoot.querySelector('mwc-textfield');
    if (!elem) {
      elem = this.shadowRoot.querySelector('mwc-textarea');
    }
    this.elem = elem;
  }
}
